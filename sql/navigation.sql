...
-- ----------------------------
INSERT INTO `nav_admin` VALUES ('1', 'mr', 'e10adc3949ba59abbe56e057f20f883e', '2015-01-28 00:00:00', '2016-06-30 12:55:19', '119.53.186.93');
...
CREATE TABLE `nav_datalist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='数据表';
...
INSERT INTO `nav_datalist` VALUES ('97', '挑战极限', '15', '17', '22', 'http://study.mingrisoft.com/', '0', '5', '0', null);
...
CREATE TABLE `nav_elementary_level` (
  ...
  `middle_id` int(8) DEFAULT '0' COMMENT '中级分类id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='初级分类表';
...
CREATE TABLE `nav_high_level` (
  ...
  `sort` int(8) DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='高级分类表';
...
INSERT INTO `nav_high_level` VALUES ('21', '体育', '1', 'left', '8');
...
CREATE TABLE `nav_hot` (
  ...
  `picture` varchar(255) DEFAULT NULL COMMENT '图片',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COMMENT='热门数据表';
...
CREATE TABLE `nav_middle_level` (
  ...
  `high_id` int(8) DEFAULT '0' COMMENT '高级分类id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='中级分类表';
...
INSERT INTO `nav_middle_level` VALUES ('42', '体育', '0', '1', '15');
